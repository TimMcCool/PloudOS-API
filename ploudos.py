...
class ploudos:
            ...
            if keep_traffic is True:
                ...
                while True:
                    ...
                    if not rstatus == response["status"]:
                        print('\033[95m' + "[PLOUDOS] Startup status: " + response["status"] + '\033[0m')
    ...
    class PloudosSession:
        ...
        def get_server(self, id):
            ...
            return ploudos.PloudosServer(self, id, **response)
        ...
        def get_servers_with_name(self, name : str):
            ...
            for item in raw_servers:
                servers.append(ploudos.PloudosServer(self, item['_id'], **item))
        ...
        def servers(self): #web scrapes the html
            ...
            for server_id in server_ids:
                try:
                    ...
                    my_servers.append(ploudos.UncreatedPloudosServer(server_id))
    ...
    def login(username, password): #logs in to the ploudos account
        ...
        return ploudos.PloudosSession(username, cookie)
